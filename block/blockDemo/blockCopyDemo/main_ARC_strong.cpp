...
static void __main_block_func_0(struct __main_block_impl_0 *__cself) {
  MyPerson *__strong person = __cself->person; // bound by copy
                    ...
                    NSLog((NSString *)&__NSConstantStringImpl__var_folders_kl_mghcpydn7wl8ch2z9jz19pg00000gn_T_main_c0d2ae_mi_0, ((NSInteger (*)(id, SEL))(void *)objc_msgSend)((id)person, sel_registerName("age")));
                }
// copy函数
...
int main(int argc, const char * argv[]) {
    /* @autoreleasepool */ { __AtAutoreleasePool __autoreleasepool; 
        ...
        // 定义block
        MyBlock block = ((void (*)())&__main_block_impl_0((void *)__main_block_func_0, &__main_block_desc_0_DATA, person, 570425344));
...
static void __test1_block_func_0(struct __test1_block_impl_0 *__cself) {
  MyPerson *__strong person = __cself->person; // bound by copy
            ...
            NSLog((NSString *)&__NSConstantStringImpl__var_folders_kl_mghcpydn7wl8ch2z9jz19pg00000gn_T_main_c0d2ae_mi_1, ((NSInteger (*)(id, SEL))(void *)objc_msgSend)((id)person, sel_registerName("age")));
        }
